                      ...
                      {members.length > 0 ? members.map(member => {
                        return (
                          <tr key={member._id} className="border-t-2 border-emerald-300 hover:bg-emerald-50">
                            ...
                            <td className="px-4 py-3 text-emerald-900 font-semibold text-sm">
                              {member.pickMember ? `${member.pickMember.firstname} ${member.pickMember.lastname}` : '—'}
                            </td>
                            <td className="px-4 py-3 text-center">
                              <div className="flex gap-2 justify-center">
                                <button onClick={() => handleEditMember(member)} className="bg-blue-500 text-white p-2 rounded hover:bg-blue-600 transition">
                                  <Edit2 className="w-4 h-4" />
                                </button>
                                <button onClick={() => handleDeleteMember(member._id)} className="bg-red-500 text-white p-2 rounded hover:bg-red-600 transition">
